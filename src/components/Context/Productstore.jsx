...
function Productstore({ children }) {
  ...
  return (
    <>
      ...
      <Pro.Provider value={{
        MenData, HomeData, WomenData, FormalData, EthnicData, CasualData, AccessoriesData,
        handleAddToCart, handleAddToWishlist, handleRemoveFromCart, handleIncreaseQuantity, handleDecreaseQuantity,
        cartItems, wishlistItems
      }}>
        {children}
      </Pro.Provider>

      {/* <Pro.Provider value={{MenData, HomeData, WomenData,FormalData,EthnicData,CasualData,AccessoriesData, handleAddToCart, handleAddToWishlist, cartItems,wishlistItems,}}>
        {children}
        </Pro.Provider> */}
